 ...
 */
class VOIETxverifyReportIncomeStreamForAccountsInInstitutionsInPayStatements implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \FinicityAPILib\Models\VOIETxverifyReportTransactionForPayStatements[] $transactions public property
     */
    public $transactions;
    ...
    public function __construct()
    {
        if (12 == func_num_args()) {
            ...
            $this->netAnnual               = func_get_arg(5);
            $this->projectedNetAnnual      = func_get_arg(6);
            $this->estimatedGrossAnnual    = func_get_arg(7);
            $this->projectedGrossAnnual    = func_get_arg(8);
            $this->averageMonthlyIncomeNet = func_get_arg(9);
            $this->incomeStreamMonths      = func_get_arg(10);
