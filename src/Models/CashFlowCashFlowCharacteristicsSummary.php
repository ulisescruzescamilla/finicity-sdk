 ...
 */
class CashFlowCashFlowCharacteristicsSummary implements JsonSerializable
{
    /**
     * List of attributes for each month
     * @required
     * @var \FinicityAPILib\Models\CashFlowMonthlyCashFlowCharacteristicSummaries[] $monthlyCashFlowCharacteristicSummaries public property
     */
    public $monthlyCashFlowCharacteristicSummaries;
     ...
     * @param array  $monthlyCashFlowCharacteristicSummaries                  Initialization value for $this-
    ...
    {
        if (9 == func_num_args()) {
            $this->monthlyCashFlowCharacteristicSummaries                  = func_get_arg(0);
    ...
    {
        $json = array();
        $json['monthlyCashFlowCharacteristicSummaries']                  = $this->monthlyCashFlowCharacteristicSummaries;
