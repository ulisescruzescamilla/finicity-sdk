...
class GetReportsByCustomerController extends BaseController
{
    ...
    public function getAssetSummaryReportByCustomer(
        ...
        $_queryBuilder = '/decisioning/v3/customers/{customerId}/reports/{reportId}';
    ...
    public function getReportByCustomer(
        ...
        //check that all required arguments are provided
        if (!isset($customerId, $reportId, $purpose, $accept, $contentType)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
        }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getVOIEPaystubWith_txverify_ReportByCustomer(
        $customerId,
        $reportId,
        $purpose,
        $accept,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getVOIEPayrollReportByCustomer(
        $customerId,
        $reportId,
        $purpose,
        $accept,
     ...
     * @param string $customerId   Finicity’s ID of the customer
     * @param string $reportId     Finicity’s ID of the report
     * @param string $contentType  Replace 'json' with 'xml' if preferred
     * @param string $purpose      2-digit code from Permissible Purpose Codes, specifying the reason for retrieving
     *                             this report.
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getCashFlowReportBusiness(
        $accept,
        $customerId,
        $reportId,
        $contentType,
        ...
        //check that all required arguments are provided
        if (!isset($accept, $customerId, $reportId, $contentType, $purpose)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
        }
        ...
        return $mapper->mapClass($response->body, 'FinicityAPILib\\Models\\CashFlowRecordBusiness');
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getVOIEPaystubReportByCustomer(
        $customerId,
        $reportId,
        $purpose,
        $accept,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getVOEPayrollReportByCustomer(
        $customerId,
        $reportId,
        $purpose,
        $accept,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getVOETransactionsReportByCustomer(
        $customerId,
        $reportId,
        $purpose,
        $accept,
