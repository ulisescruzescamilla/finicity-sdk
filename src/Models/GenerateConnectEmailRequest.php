 ...
 */
class GenerateConnectEmailRequest implements JsonSerializable
{
    /**
    ...
    /**
     * The type of connect flow you want for the customer/consumer. Email does not support types
     * aggregation, lite and fix. See Finicity Connect Type For Definitions.
     * @required
     ...
     * application. See [Connect Webhook Event](https://docs-new.finicitydev.com/connect-webhooks/) for
     * event details.
     ...
     * See this article for [Details](https://docs-new.finicitydev.com/connect-custom-webhook-data-and-
     * headers/).
     ...
     * this article for [Details](https://docs-new.finicitydev.com/connect-custom-webhook-data-and-
     * headers/).
     ...
     * [Details](https://docs-new.finicitydev.com/connect-institutions-options/)
     ...
     * @required
     * @var \FinicityAPILib\Models\ConnectEmailOptions $email public property
     */
    public $email;
    ...
    public function __construct()
    {
        switch (func_num_args()) {
            case 16:
                ...
                $this->skipReport          = func_get_arg(4);
                $this->fromDate            = func_get_arg(5);
                $this->paystubs            = func_get_arg(6);
                $this->redirectUri         = func_get_arg(7);
                $this->webhook             = func_get_arg(8);
                $this->webhookContentType  = func_get_arg(9);
                $this->webhookData         = func_get_arg(10);
                $this->webhookHeaders      = func_get_arg(11);
                $this->institutionSettings = func_get_arg(12);
                $this->reportCustomFields  = func_get_arg(13);
                $this->analytics           = func_get_arg(14);
