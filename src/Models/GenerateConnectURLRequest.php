 ...
 */
class GenerateConnectURLRequest implements JsonSerializable
{
    /**
     ...
     * a specific set of accounts under one institutionLoginId
     * @var string|null $institutionLoginId public property
     */
     ...
     * @param string  $institutionLoginId  Initialization value for $this->institutionLoginId
    ...
    public function __construct()
    {
        switch (func_num_args()) {
            case 17:
                ...
                $this->institutionLoginId  = func_get_arg(5);
                $this->skipReport          = func_get_arg(6);
                $this->fromDate            = func_get_arg(7);
                $this->paystubs            = func_get_arg(8);
                $this->redirectUri         = func_get_arg(9);
                $this->webhook             = func_get_arg(10);
                $this->webhookContentType  = func_get_arg(11);
                $this->webhookData         = func_get_arg(12);
                $this->webhookHeaders      = func_get_arg(13);
                $this->institutionSettings = func_get_arg(14);
                $this->reportCustomFields  = func_get_arg(15);
                $this->analytics           = func_get_arg(16);
                break;
