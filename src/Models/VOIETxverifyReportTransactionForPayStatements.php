 ...
 */
class VOIETxverifyReportTransactionForPayStatements implements JsonSerializable
{
    /**
     ...
     * @required
     * @var array $payStatementMatchTypes public property
     */
    ...
    public function __construct()
    {
        if (8 == func_num_args()) {
            ...
            $this->payStatementMatchTypes   = func_get_arg(7);
        }
    }
