 ...
 */
class PayrollEmploymentHistory implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \FinicityAPILib\Models\PayrollIncomeRecord $income public property
     */
    public $income;
     ...
     * @param PayrollIncomeRecord     $income        Initialization value for $this->income
     */
