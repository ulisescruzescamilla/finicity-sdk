 ...
 */
class VOIEWithStatementConstraints implements JsonSerializable
{
    /**
     * The asset Ids (generated using the Store Customer Pay Statment API) for the paystubs included in the
     * report, and other report optional report constraints.
     * @required
     * @var \FinicityAPILib\Models\VOIEWithStatementData $voieWithStatementData public property
     */
     ...
     * @param VOIEWithStatementData $voieWithStatementData Initialization value for $this->voieWithStatementData
     * @param array                 $reportCustomFields    Initialization value for $this->reportCustomFields
     */
    public function __construct()
    {
        if (2 == func_num_args()) {
            $this->voieWithStatementData = func_get_arg(0);
    ...
    {
        $json = array();
        $json['voieWithStatementData'] = $this->voieWithStatementData;
