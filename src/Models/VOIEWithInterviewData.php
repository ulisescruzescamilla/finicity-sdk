 ...
 */
class VOIEWithInterviewData implements JsonSerializable
{
    /**
     * An array of txVerifyInterview objects.
     * @required
     * @maps txVerifyInterview
     * @var \FinicityAPILib\Models\TxverifyInterview[] $txverify_Interview public property
     */
     ...
     * @param array $txverify_Interview   Initialization value for $this->txverify_Interview
    ...
    {
        $json = array();
        $json['txVerifyInterview']    = $this->txverify_Interview;
