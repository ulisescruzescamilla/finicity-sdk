 ...
 */
class CashFlowPossibleLoanDepositsAccount implements JsonSerializable
{
    /**
     * Finicity account ID
     * @required
     ...
     * @param string  $aggregationStatusCode Initialization value for $this->aggregationStatusCode
