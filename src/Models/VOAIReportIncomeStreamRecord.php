 ...
 */
class VOAIReportIncomeStreamRecord implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \FinicityAPILib\Models\VOAIReportTransactionsForIncomeStreams[] $transactions public property
     */
    public $transactions;
    ...
    public function __construct()
    {
        if (14 == func_num_args()) {
            ...
            $this->incomeStreamMonths      = func_get_arg(12);
            $this->transactions            = func_get_arg(13);
        }
    }
