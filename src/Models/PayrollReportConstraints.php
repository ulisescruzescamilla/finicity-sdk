 ...
 */
class PayrollReportConstraints implements JsonSerializable
{
    /**
     * @todo Write general description for this property
     * @required
     * @var \FinicityAPILib\Models\PayrollData $payrollData public property
     */
    public $payrollData;
     ...
     * @param PayrollData $payrollData        Initialization value for $this->payrollData
