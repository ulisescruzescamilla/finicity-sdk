 ...
 */
class TransactionReportConstraints implements JsonSerializable
{
    /**
    ...
    /**
     * The ending timestamp for the date range. The value must be greater than fromDate. See Handling Dates
     * and Times.
     * @var integer|null $toDate public property
     */
    public $toDate;

    /**
     * True: Include pending transactions in the report. False: Set by default.
     * @var bool|null $includePending public property
     */
    public $includePending;
     ...
     * @param integer $toDate             Initialization value for $this->toDate
     * @param bool    $includePending     Initialization value for $this->includePending
    ...
    public function __construct()
    {
        if (5 == func_num_args()) {
            ...
            $this->toDate             = func_get_arg(2);
            $this->includePending     = func_get_arg(3);
            $this->reportCustomFields = func_get_arg(4);
        }
    }
    ...
    public function jsonSerialize()
    {
        ...
        $json['includePending']     = $this->includePending;
