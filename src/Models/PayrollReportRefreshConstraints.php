 ...
 */
class PayrollReportRefreshConstraints implements JsonSerializable
{
    /**
     * @todo Write general description for this property
     * @required
     * @var \FinicityAPILib\Models\PayrollResponseData $payrollData public property
     */
    public $payrollData;
     ...
     * @param PayrollResponseData $payrollData        Initialization value for $this->payrollData
