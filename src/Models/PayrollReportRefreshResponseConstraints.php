 ...
 */
class PayrollReportRefreshResponseConstraints implements JsonSerializable
{
    /**
     * @todo Write general description for this property
     * @required
     * @var \FinicityAPILib\Models\PayrollReportData $payrollData public property
     */
    public $payrollData;
     ...
     * @param PayrollReportData $payrollData        Initialization value for $this->payrollData
