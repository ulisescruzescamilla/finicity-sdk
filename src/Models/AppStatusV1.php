 ...
 */
class AppStatusV1 implements JsonSerializable
{
    /**
     ...
     * @var string|null $euaId public property
     */
    public $euaId;
     ...
     * @param string  $euaId              Initialization value for $this->euaId
