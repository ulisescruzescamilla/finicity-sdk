 ...
 */
class ModifyAppRegistrationRequest implements JsonSerializable
{
    /**
     ...
     * given to the end user.
     * @required
     * @var integer $ownerPostalCode public property
     */
     ...
     * @param integer $ownerPostalCode   Initialization value for $this->ownerPostalCode
