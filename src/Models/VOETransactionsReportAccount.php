 ...
 */
class VOETransactionsReportAccount implements JsonSerializable
{
    /**
     ...
     * @required
     * @var \FinicityAPILib\Models\VOETransactionsReportIncomeStreamRecord[] $incomeStreams public property
     */
