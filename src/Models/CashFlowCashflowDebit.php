 ...
 */
class CashFlowCashflowDebit implements JsonSerializable
{
    /**
     * List of attributes for each month
     * @required
     * @var \FinicityAPILib\Models\CashFlowMonthlycashflowDebits[] $monthlyCashFlowDebits public property
     */
    public $monthlyCashFlowDebits;
     ...
     * @param array  $monthlyCashFlowDebits              Initialization value for $this->monthlyCashFlowDebits
    ...
    {
        if (7 == func_num_args()) {
            $this->monthlyCashFlowDebits              = func_get_arg(0);
    ...
    {
        $json = array();
        $json['monthlyCashFlowDebits']              = $this->monthlyCashFlowDebits;
