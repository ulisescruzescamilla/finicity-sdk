 ...
 */
class AssetSummaryReportRecord implements JsonSerializable
{
    /**
     ...
     * report
     * @required
     * @var \FinicityAPILib\Models\AssetSummaryReportInstitution[] $institutions public property
     */
    public $institutions;
